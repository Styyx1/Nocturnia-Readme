...
This readme constsist of multiple parts. Check out the other parts like [Changes to gameplay](changes%20to%20gameplay.md) and the [Beginner's Guide](Nocturnia%20Beginners%20guide.md).

![Nocturnia-banner](https://github.com/chri3i/Nocturnia-Readme/blob/main/.github/NocturniaTitleResized.png)
...
Nocturnia is a list focused on making Skyrim: Anniversary Edition (AE) into a dark fantasy roleplaying game. Many new mechanics and changes are present to offer an alternate take on the game. You can view many of these changes in the [Changes to Gameplay](https://github.com/chri3i/Nocturnia-Readme/blob/main/changes%20to%20gameplay.md) article and biggie_boss' showcase below.

[![Nocturnia Showcase](https://img.youtube.com/vi/dpUbcLK0zB4/hqdefault.jpg)](https://youtu.be/dpUbcLK0zB4?t)


#  **__Nocturnia requires the *full* AE upgrade, which means you must       *purchase* the AE edition of the game for the list to function.__**  
...
It also disables EXP gain on the perks you don't have put any perk points into. More info in the [Beginner's Guide](Nocturnia%20Beginners%20guide.md).
...
- For player homes please refer to [the list of player homes](https://github.com/chri3i/Nocturnia-Readme/blob/main/Nocturnia%20Player%20Homes.md)
...
- The full list of mods in Nocturnia can be viewed [here](https://loadorderlibrary.com/lists/Nocturnia-1).
- This readme constsist of multiple parts. Check out the other parts like [Changes to gameplay](changes%20to%20gameplay.md) and the [Beginner's Guide](Nocturnia%20Beginners%20guide.md).
...
Nocturnia is aimed at mid tier machines so a system like the following is advised:
...
- To install a beta version of the list (I might publish updates as an open beta first to ensure stability with the main release) refer to the [beta install instructions](https://github.com/chri3i/Nocturnia-Readme/blob/main/.github/Beta%20Release%20instructions.md)
...
Nocturnia comes already set up with [E.V.C. ENB](https://www.nexusmods.com/skyrimspecialedition/mods/71743).

In the executables drop down menu in MO2, you will find an ENB Organizer that provides you with a few options. Depending on your PC you might want to check them out. If you want to install your own ENB put them into a separate folder in Nocturnia/tools/Enb Manager/Managed ENB. You need to manually add them in the ENB Manager program afterwards. Click on Skyrim --> Go to the preset Tab --> Add preset.
...
Another reminder to check out the [changes to gameplay](changes%20to%20gameplay.md) and the Nocturnia [beginners guide](Nocturnia%20Beginners%20guide.md).
...
Nocturnia also makes use of a few GUI menus:
...
![IED instructions](https://github.com/chri3i/Nocturnia-Readme/blob/main/.github/NocturniaIEDinstructionsNew.png)
...
Controller compatibility is turned on by default as Nocturnia uses a neat SKSE plugin called [Auto Input Switch](https://www.nexusmods.com/skyrimspecialedition/mods/54309) and therefor it won't interfere for anyone using keyboard and mouse for controls.
If you use a gamepad, however, you should make yourself familiar with the changed controls. Nocturnia uses [TUCS](https://www.nexusmods.com/skyrimspecialedition/mods/29381) with a small change so that the tween menu is ``RB + Start`` instead of ``LB + Start``. If you don't like the control layout you can disable the mods under *Gamepad support* at any time.
...
Enemies are spawned from leveled lists which are semi-random. Nocturnia is not de-leveled but there are occasionally high level enemies in lower level areas. You can't defeat them at low levels. Try your luck later or use some strategies to overcome these hurdles. There are also some extremly powerful bosses scattered around the world. Those are meant for mid to high level characters. Avoid them as a low level character.
...
Make sure you meet the requirements for the equipment you want to use. By default Nocturnia restricts certain equipments to specific skill levels.
...
Nocturnia ships with an ENB setup that is configured to match the look of the list. If you wish to make some changes though, here are a few common tweaks. I recommend opening the console before doing edits.
...
In case you have questions like these, refer to the [modification page](https://github.com/chri3i/Nocturnia-Readme/blob/main/.github/Nocturnia_Modifications.md).<br > Note that you need to know a bit about modding to successfully change stuff. We have a general modding channel in our support server where you can talk about modifications.

## Removing the Modlist
Simply delete the folder and you have uninstalled it.

## Known Issues
- Before reporting any issues please refer to [Known Issues](https://github.com/chri3i/Nocturnia-Readme/blob/main/Known%20Issues.md) to see if your issue is mentioned there already. While i try to fix any issues that come up, I can't fix everything, please be patient.

## I found a bug

Go to the GitHub [Issues](https://github.com/chri3i/Nocturnia-Readme/issues) page and check if your issue was already reported. If you found no similar posts, create a new issue by clicking the green `New issues` button in the top right corner. Select `Bug report` and fill out the document.
...
- Anna for adjusting the ENBs for Nocturnia even though they aren't used anymore.
